<h2>  Largest Number At Least Twice of Others</h2><hr><div bis_skin_checked="1"><p>You are given an integer array <code>nums</code> where the largest integer is <strong>unique</strong>.</p>
